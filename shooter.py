...
class ScreenFade():
    ...
    def fade(self):
        ...
        if self.direction == 2:  # desbotamento da tela inteira
...
# Cria tela de fade
intro_face  = ScreenFade(1, BLACK, 4)
...
while run:
    ...
    if start_game == False:
        ...
        # Monstrar a tela de introdução
        if start_intro == True:
            if intro_face.fade():
                start_intro = False
                intro_face.fade_counter = 0
